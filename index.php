...
<head>
    ...
    <link rel="shortcut icon" href="assets/images/logo_pesat.png" type="image/x-icon">
        ...
        <aside class="main-sidebar sidebar-dark-info elevation-4 bg-gray">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="assets/dist/img/avatar2.png" class="img-circle elevation-1" alt="User Avatar">
                    </div>
                    <div class="info">
                        <a href="#" class="d-block">shakilla alsava</a>
                                        </div>
                </div>
